<template>
    <div>
        <CRow>
            <CCol lg="3">
                <router-link :to="{ name: 'store:product:domain:search' }"
                             class="text-decoration-none">
                    <CWidgetIcon color="success"
                                 text="Domain Hosting">
            ...
            <CCol lg="3">
                <router-link :to="{ name: 'store:product:index' }"
                             class="text-decoration-none">
                    <CWidgetIcon color="success"
                                 text="Mail Hosting">
